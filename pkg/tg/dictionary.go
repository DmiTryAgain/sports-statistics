...
var (
	messagesByLang = map[language]map[int]string{
		langRU: {
			...
			addHelpMsg: "Чтобы записать результаты, отправь команду на добавление упражнения (`сделал`). Затем, через " +
			...
			showHelpMsg: "Чтобы показать статистику, отправь команду `Покажи`. Затем укажи упражнение." +
