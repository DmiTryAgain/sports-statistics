...
var (
	...
	exerciseByLang = map[language]map[string]Exercise{
		langRU: {
			...
			"подъём ног к турнику":       hangingLegRaiseEx,
			"подъем ног к турнику":       hangingLegRaiseEx,
			"подъёмы ног к турнику":      hangingLegRaiseEx,
			"подъемы ног к турнику":      hangingLegRaiseEx,
			...
			"ноги к турнику":             hangingLegRaiseEx,
			...
			"подъём коленей к перекладине":  hangingKneeRaiseEx,
			"подъем коленей к перекладине":  hangingKneeRaiseEx,
			"подъём колен к перекладине":    hangingKneeRaiseEx,
			"подъем колен к перекладине":    hangingKneeRaiseEx,
			"подъём коленей к турнику":      hangingKneeRaiseEx,
			"подъем коленей к турнику":      hangingKneeRaiseEx,
			"подъём колен к турнику":        hangingKneeRaiseEx,
			"подъем колен к турнику":        hangingKneeRaiseEx,
			"колени в висе":                 hangingKneeRaiseEx,
			"колени на турнике":             hangingKneeRaiseEx,
			"колени на перекладине":         hangingKneeRaiseEx,
			"колени к перекладине":          hangingKneeRaiseEx,
			"колени к турнику":              hangingKneeRaiseEx,
